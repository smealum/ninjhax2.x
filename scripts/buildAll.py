...
def isVersionPossible(v):
	...
	if v[4]=="22528_usa" and v[1]!="U":
		return False
	if (v[2]==8203 and (v[4]=="20480_usa" or v[4]=="21504_usa"  or v[4]=="22528_usa" or v[4]=="23552_usa" or v[4]>=16404)) or (v[2]==9221 and v[4]!="20480_usa" and v[4]!="21504_usa" and v[4]!="22528_usa" and v[4]!="23552_usa" and v[4]!="24578_usa" and v[4]!="25600_usa" and v[4]<16404):
		return False
	return True
...
roVersions=[4096]
menuVersions=[11272, 12288, 13330, 14336, 15360, 16404, 17415, 19456, 20480, 21504, 22528, 23552, 24576, "20480_usa", "21504_usa", "22528_usa", "23552_usa", "24578_usa", "25600_usa"]
