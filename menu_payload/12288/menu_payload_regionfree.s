	...
	rop: ; real ROP starts here
		...
		rop_loop:
			...
			; mask it with desired key combo
  			.word 0x00122e1c ; and r0, r0, r4 ; pop {r4, r5, r6, r7, r8, pc}
				.word 0xDEADBABE ; r4 (garbage)
			...
			.word 0x00214988 ; pop {r1, pc}
				.word MENU_KEYCOMBO
  			.word 0x001fc0ec ; cmp r0, r1 ; mvnls r0, #0 ; movhi r0, #1 ; pop {r4, pc}
				.word 0xDEADBABE ; r4 (garbage)
			...
			.word 0x00150160 ; pop {r2, r3, r4, r5, r6, pc}
				...
				.word 0xDEADBABE ; r6 (garbage)
			.word 0x00154ef4 ; streq r5, [r2, #0x30] ; pop {r4, r5, r6, pc}
